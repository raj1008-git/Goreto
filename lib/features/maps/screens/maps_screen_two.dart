...
class MapsScreenTwo extends StatefulWidget {
  final PlaceModel? place;

  const MapsScreenTwo({super.key, this.place});

  @override
  State<MapsScreenTwo> createState() => _MapsScreenState();
}

class _MapsScreenState extends State<MapsScreenTwo> {
